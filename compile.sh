...
for variant in "","" "-Dark","-dark", "", "-Darker"; do
  ...
  if [ $1="-Darker" ]; then
    sassc -t expanded src/gtk-3.0/gtk-darker.scss $OUTPUT/Aduru-Darker/gtk-3.0/gtk.css
    sassc -t expanded src/gtk-3.0/gtk-dark.scss $OUTPUT/Aduru-Darker/gtk-3.0/gtk-dark.css
    cp src/gtk-3.0/assets/* $OUTPUT/Aduru-Darker/gtk-3.0/assets
    cp src/gtk-2.0/common-files/* $OUTPUT/Aduru-Darker/gtk-2.0/
    cp src/gtk-2.0/assets/common-assets/* $OUTPUT/Aduru-Darker/gtk-2.0/assets
    cp src/gtk-2.0/assets/light-assets/* $OUTPUT/Aduru-Darker/gtk-2.0/assets
    cp src/gtk-2.0/gtkrc-darker $OUTPUT/Aduru-Darker/gtk-2.0/gtkrc
  fi
